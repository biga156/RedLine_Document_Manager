	...
	<script>
		...
		/*	function orderByValue() {
				...
				//date ass: "select  * from documents, user where use_id=doc_user order by doc_date";
				//date desc: "select  * from documents, user where use_id=doc_user order by doc_date desc";
				//Name ass: "select  * from documents, user where use_id=doc_user order by doc_label";
				//Name desc: "select  * from documents, user where use_id=doc_user order by doc_label desc";
				//valdiation: "select  * from documents, user where use_id=doc_user order by doc_validation";
			}*/
